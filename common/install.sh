...
sleep 3
ui_print "- 最終確認"
ui_print "  Final confirmation"
ui_print " "
sleep 2
ui_print "- 繼續安裝即代表："
ui_print "  Continue installation is the representative:"
ui_print " "
sleep 2
ui_print "  您已閱讀【項目說明】"
ui_print "  You have read [Project Description]"
ui_print " "
sleep 2
ui_print "  遇到問題請先看【修改說明】"
ui_print "  If you encounter a problem, please see 
  [Modify instructions]"
ui_print " "
sleep 2
ui_print "  您已閱讀本上述【警告訊息】"
ui_print "  You have read the above [Warning Message] above"
ui_print " "
sleep 2
ui_print "  您自行承擔一切後果"
ui_print "  You bear all the consequences"
ui_print " "
sleep 2
ui_print "  選擇否以繼續安裝"
